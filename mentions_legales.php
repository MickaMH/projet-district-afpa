...
<main class="container-fluid pb-5">
    ...
    <div class="row d-flex justify-content-center">
        ...
        <div class="col-9 col-lg-3 fs-1 mt-3 mt-lg-3 text-center">

            <p class="lettres fw-medium fond_intitule">MENTIONS LÉGALES</p>
    ...
    <div class="row d-flex justify-content-center">
        ...
        <div class="col-11 col-lg-3 fs-5 mb-lg-3 text-center">
    ...
    <div class="row d-flex justify-content-center">
        ...
        <p class="col-11 col-lg-8 fs-5 mt-lg-4">
            ...
            visiteurs, ci-après l' "Utilisateur", du site TheDistrict.fr, ci-après le "Site", les présentes mentions
            légales.<br>
            <br>
        ...
        <h1 class="col-11 col-lg-8 fs-2">ARTICLE 1 - L'ÉDITEUR</h1>

        <p class="col-11 col-lg-8 fs-5 mt-4">
            L’édition et la direction de la publication du Site est assurée par Mickael MIcka, domiciliée 1 rue de la
            paix 80000 Amiens, dont le numéro de téléphone est 0612345678, et l'adresse e-mail
        ...
        <h1 class="col-11 col-lg-8 fs-2">ARTICLE 2 - L'HÉBERGEUR</h1>

        <p class="col-11 col-lg-8 fs-5 mt-4">
            L'hébergeur du Site est la société PlanetHoster, dont le siège social est situé au 4416 Louis-B. -
            Mayer, Laval, Québec, Canada H7P 0G1 , avec le numéro de téléphone : FR: +33 1 76 60 41 43 
            et le site web : www.planethoster.net/fr.<br>
            <br>
        </p>

        <h1 class="col-11 col-lg-8 fs-2">ARTICLE 3 - ACCÈS AU SITE</h1>
        ...
        <h1 class="col-11 col-lg-8 fs-2">ARTICLE 4 - COLLECTE DES DONNÉES</h1>
        ...
        <ul class="col-11 col-lg-8 fs-5 ms-lg-5">
            <li>par mail à l'adresse email : TheDistrict@gmail.com</li>
            <li>par voie postale au : The District 1 rue de la paix 80000 Amiens</li>
